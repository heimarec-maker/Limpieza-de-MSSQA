...
export async function ejecutarBorrado(serial, usuario) {
...
export async function limpiarServItem(serial, usuario) {
...
export async function limpiarServReq(serial, usuario) {
