      ...
      <div className="manual-page">
        ...
        <aside className="manual-toc">
          ...
          <ul className="manual-toc-list">
            ...
            <li><a href="#flujos" className={activeSection === 'flujos' ? 'active' : ''} onClick={(e) => scrollToSection(e, 'flujos')}>5. Flujos Lógicos</a></li>
            <li><a href="#deploy" className={activeSection === 'deploy' ? 'active' : ''} onClick={(e) => scrollToSection(e, 'deploy')}>6. Instalación y Despliegue</a></li>
            <li><a href="#seguridad" className={activeSection === 'seguridad' ? 'active' : ''} onClick={(e) => scrollToSection(e, 'seguridad')}>7. Seguridad y Sesiones</a></li>
          </ul>
        </aside>
